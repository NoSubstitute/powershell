## I will put the script's content here tomorrow.
## This script doesn't work anymore, as it used the now deprecated Azure AD APIs, replaced by MS Graph APIs.
## I need help converting the AAD parts.
